...
def infer_root_output_names(
    ...
    If any anonymous expression appears (e.g. nw.all()), then give up on tracking root names and just set it to None.
    """
...
def reuse_series_implementation(
    ...
    **kwargs: Any,
    ...
    root_names, output_names = infer_root_output_names(expr, **kwargs)
